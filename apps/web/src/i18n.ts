...
const translations = {
  en: {
    ...
    downloadHelpStep3: 'Enter the client token when prompted.',
    downloadHelpStep3Link: 'Generate a new token from the Devices page.',
  ...
  zh: {
    ...
    downloadHelpStep3: '按提示输入客户端令牌。',
    downloadHelpStep3Link: '在设备页面上可以生成新令牌。',
