...
const translations = {
  en: {
    ...
    browse: 'Browse',
    browseDirectory: 'Browse remote directory',
    directoryBrowser: 'Directory Browser',
    directoryPathPrompt: 'Enter directory path:',
    ...
    downloadHelpStep3: 'Enter the client token when prompted. Generate a new token from the',
    downloadHelpStep3Link: 'Devices page',
    downloadHelpStep3Suffix: '',
    downloadHelpStep4: 'The device will appear in the',
    downloadHelpStep4Link: 'device list',
    downloadHelpStep4Suffix: 'and you can start sessions.',
  ...
  zh: {
    ...
    browse: '浏览',
    browseDirectory: '浏览远程目录',
    directoryBrowser: '目录浏览器',
    directoryPathPrompt: '请输入目录路径：',
    ...
    downloadHelpStep3: '按提示输入客户端令牌。在',
    downloadHelpStep3Link: '设备页面',
    downloadHelpStep3Suffix: '上可以生成新令牌。',
    downloadHelpStep4: '设备将出现在',
    downloadHelpStep4Link: '设备列表',
    downloadHelpStep4Suffix: '中，之后可以开始会话。',
